...
const Hero = () => {
  return (
    <>
      <div className="w-full min-h-[80vh] flex flex-col md:flex-row items-center justify-between overflow-x-hidden">
      ...
      <div className="w-full flex justify-end px-8 gap-1.5">
      <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/shaheer831/Cardo"
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://www.instagram.com/itx_shaheer____/"
          className="hover:scale-105 transition-transform"
        >
          <InstaBtn />
        </a>
